package anacolladosanchez;

import java.util.*;

public class AnalistaED_20487094M {

    static final double FACTOR_HORA_EXTRA = 1.2;
    private String nombreCompleto, dni;
    private double salarioBasePorHora = 10.56;

    public AnalistaED_20487094M(String nombreCompleto, String dni) {
    ...
    public static void main(String[] args) {
        ...
        AnalistaED_20487094M emp = new AnalistaED_20487094M("ANA COLLADO", "20487094M");
        int horasExtra = 2;
